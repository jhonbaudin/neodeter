  ...
  return (
    <div className="page-banner">
      ...
      <div className="relative section-container">
        <div className="mb-5 flex w-full max-w-full flex-col items-start gap-1.5 rounded-[1.5rem] border border-white/20 bg-white/10 px-4 py-2 text-[10px] font-semibold uppercase leading-relaxed tracking-[0.12em] text-primary-foreground/90 backdrop-blur-sm sm:inline-flex sm:w-auto sm:flex-row sm:items-center sm:gap-2 sm:rounded-full sm:text-[11px] sm:tracking-[0.22em]">
